...
if __name__ == '__main__':
    ...
    plt.ion()
    fig, ax = plt.subplots()
    sns.barplot(x='line', y='season', hue='character', hue_order=characters,
                orient='h', palette='viridis', data=dfg, ax=ax)
    ...
    if not os.path.isfile(fp):
        fig.savefig('docs/analysis_outputs/count_of_spoken_lines_per_season_and_character.png')
